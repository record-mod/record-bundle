...
import { DiscordType } from "./types/components";
...
export const Discord: DiscordType = findByProps(
    "createStyles",
    "dismissAlerts",
    "ContextMenu"
);
...
export const url =
    nativeModuleProxy.NativeLinkingModule || nativeModuleProxy.DCDLinkingManager
        ? {
              openURL,
              ...
              isDiscordConnectOauth2Deeplink: () => {
                  console.warn(
                      "url.isDiscordConnectOauth2Deeplink is not implemented and will always return false"
                  );
                  return false;
              },
              showLongPressUrlActionSheet: () =>
                  console.warn(
                      "url.showLongPressUrlActionSheet is not implemented"
                  ),
              handleMessageLinking: findByFilePathLazy(
